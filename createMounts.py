...
def remove_normal_mounts(df):
    ...
    condition_d_or_e_true = df['Owned'] | df['Gear Set']
    ...
    default_mount = pd.DataFrame([{"Name": "Default", "Level": 1, "Health": 0, "Damage": 0, "Resist": 0, "Accuracy": 0, "Power Pip": 0, "Critical": 0, "Critical Block": 0, "Pierce": 0, "Stun Resist": 0, "Incoming": 0, "Outgoing": 0, "Pip Conserve": 0, "Shadow Pip": 0, "Archmastery": 0, "Source": "Drop/Vendor", "Owned": True, "Gear Set": False}])
